...
export default function Home() {
  ...
  return (
    <main className="min-h-svh bg-[#0a0707] text-white overflow-x-hidden" style={{ fontFamily: "Georgia, serif" }}>
      ...
      <section id="sobre" className="py-28 px-5 bg-[#0d0909]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <FadeSection delay={150}>
            ...
            <a href="https://wa.me/55619950399925" target="_blank" rel="noopener noreferrer" className="px-10 py-5 rounded-full uppercase tracking-widest text-sm font-semibold transition hover:scale-105 active:scale-95 inline-block" style={{ background: "#c8a078", color: "#0a0707" }}>Entrar em Contato</a>
          </FadeSection>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <FadeSection delay={100} className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="https://wa.me/55619950399925" target="_blank" rel="noopener noreferrer" className="inline-block px-10 py-5 rounded-full uppercase tracking-widest text-sm font-semibold transition hover:scale-105 active:scale-95" style={{ border: "1px solid rgba(200,160,120,0.3)", color: "#c8a078" }}>Falar no WhatsApp</a>
            </div>
          </FadeSection>
        </div>
      </section>
      ...
      <footer className="px-5 py-10" style={{ background: "#080505", borderTop: "1px solid rgba(200,160,120,0.1)" }}>
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-6 items-center">
            ...
            <a href="https://wa.me/55619950399925" target="_blank" rel="noopener noreferrer" className="text-sm transition hover:text-white" style={{ color: "#a89080" }}>WhatsApp</a>
      ...
      {/* ── WHATSAPP FIXO ── */}
      <a href="https://wa.me/55619950399925" target="_blank" rel="noopener noreferrer" aria-label="Falar no WhatsApp" className="fixed bottom-6 right-5 w-14 h-14 rounded-full flex items-center justify-center shadow-2xl transition hover:scale-110 active:scale-95 z-50" style={{ background: "#25D366" }}>
