...
function Icon({ type }: { type: string }) {
  ...
  if (type === "relatorios")    return <svg {...p}><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8M10 9H8"/></svg>;
  if (type === "avaliacoes")    return <svg {...p}><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>;
...
export default function AdminSidebar({ role }: { role: string }) {
  ...
  const linksVisiveis = menuLinks.filter(l => temPermissao(cargo, l.permissao));
      ...
      <div className="flex items-center gap-3 px-4 py-5" style={{ borderBottom: "1px solid rgba(200,160,120,0.08)" }}>
        ...
        {!collapsed && (
          <div>
            ...
            <p className="text-[10px]" style={{ color: "#6b5a4e" }}>{cargo}</p>
          </div>
        )}
